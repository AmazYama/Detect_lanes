...
def find_lane_pixels(binary_warped):
    ...
    # Get the bottom part of the image and get the histogram of it.
    ...
    # Design the sliding windows
    nwindows = 9
    margin = 100
    minpix = 50
    # Set height of windows - based on nwindow
    window_height = np.int(binary_warped.shape[0]//nwindows)

    # Identify the x and y positions of all non-zere pixels.
...
#     """To find the line based on previous line"""
...
if __name__=='__main__':
    ...
    # out_img, left_fit, right_fit = find_lane_pixels(binary_warped)
